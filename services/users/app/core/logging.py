...
class ServiceJsonFormatter(jsonlogger.JsonFormatter):
  ...
  def format(self, record: logging.LogRecord) -> str:
    ...
    # Known standard attributes we don't want to duplicate
    standard_attrs = {
      "name",
      "msg",
      "args",
    ...
    # Merge all extra fields into log_message
    for key, value in record.__dict__.items():
      if key in standard_attrs:
        continue
      if key in ("message", "severity", "logger", "module", "module_info", "timestamp", "logger_id"):
